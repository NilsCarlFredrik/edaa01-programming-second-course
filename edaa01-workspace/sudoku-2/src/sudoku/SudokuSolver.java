...
public interface SudokuSolver {
	/**
	 * Sets the number nbr in box r, c and returns nbr.
	 * 
	 * @param r
	 *            The row
	 * @param c
	 ...
	 *            The column
	 * @throws IllegalArgumentException
	 *             if r or c is outside [0..8] or nbr outside [1..9]            
	 */
	public void clearNumber(int r, int c);
	
	/**
	 *  Checks if value nbr is a valid candidate for box r,c. 
	 * 
	 * @param r
	 *            The row
	 * @param c
	 *            The column
	 * @return true if nbr is valid, false otherwise
	 * @throws IllegalArgumentException
	...
	/**
	 * Checks if all boxes has valid numbers, i.e. if the sudoku is solved.
	 ...
	 * @return true if solved, false if the sudoku can't be solved
	 */
	public boolean solve();
		
	/**
	 * Set the value of all boxes in the sudoku to 0
	 */
	public void clear();
