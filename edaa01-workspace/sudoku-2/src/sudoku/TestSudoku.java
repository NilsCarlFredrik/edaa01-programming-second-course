...
//	}
	...
	void testClearNumber() {
		...
		assertThrows(IllegalArgumentException.class, () -> test1.clearNumber(20, 6));
	}
	...
	void testSetGetMatrix() {
		...
		assertThrows(IllegalArgumentException.class, () -> test1.setMatrix(new int[2][9]));
		assertThrows(IllegalArgumentException.class, () -> test1.setMatrix(new int[9][20]));
		int[][] testGrid = new int[9][9];
		testGrid[2][7] = 10;
		assertThrows(IllegalArgumentException.class, () -> test1.setMatrix(testGrid));
